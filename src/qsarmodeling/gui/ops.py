from PySide6.QtWidgets import QApplication, QDialog, QVBoxLayout, QHBoxLayout, QLabel, QDoubleSpinBox, QPushButton, QProgressBar

class OPSConfigDialog(QDialog):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Generate model using OPS")
