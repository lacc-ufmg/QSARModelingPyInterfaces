    ...
    def on_OPS_run_button_clicked(self, _) -> None:
        if self.handler.files_ok():
            self.ops_config = {
                ...
                "output_matrix": self.builder.get_object(
                    "OPS_output_matrix"
                ).get_text(),
                "output_cv": self.builder.get_object("OPS_output_cv").get_text(),
                "output_models": self.builder.get_object(
                    "OPS_output_models"
                ).get_text(),
